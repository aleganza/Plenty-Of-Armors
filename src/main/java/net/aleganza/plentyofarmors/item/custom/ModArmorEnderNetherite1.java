...
public class ModArmorEnderNetherite1 extends ArmorItem {
    ...
    public ModArmorEnderNetherite1(RegistryEntry<ArmorMaterial> material, ArmorItem.Type slot, Settings settings) {
