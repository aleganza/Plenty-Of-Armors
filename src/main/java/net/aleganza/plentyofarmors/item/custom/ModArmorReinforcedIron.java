...
public class ModArmorReinforcedIron extends ArmorItem {
    ...
    public ModArmorReinforcedIron(RegistryEntry<ArmorMaterial> material, ArmorItem.Type slot, Settings settings) {
