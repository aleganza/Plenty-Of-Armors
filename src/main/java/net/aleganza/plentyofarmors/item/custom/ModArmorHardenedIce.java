...
public class ModArmorHardenedIce extends ArmorItem {
    ...
    public ModArmorHardenedIce(RegistryEntry<ArmorMaterial> material, ArmorItem.Type slot, Settings settings) {
    ...
    private void evaluateArmorEffects(PlayerEntity player) {
        for (Map.Entry<RegistryEntry<ArmorMaterial>, StatusEffectInstance> entry : MATERIAL_TO_EFFECT_MAP.entrySet()) {
            RegistryEntry<ArmorMaterial> mapArmorMaterial = ModArmorMaterials.HARDENED_ICE_SHARD;
