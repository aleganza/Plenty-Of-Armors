...
public class ModArmorStardusite2 extends ArmorItem {
    ...
    public ModArmorStardusite2(RegistryEntry<ArmorMaterial> material, ArmorItem.Type slot, Settings settings) {
